...
Read `SOP.md` before using this skill independently. It defines the composition workflow, asset locations, project structure, commands, QA checks, and handoff rules.
